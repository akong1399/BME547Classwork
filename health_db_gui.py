...
from health_db_client2 import add_patient_to_server
...
def design_window():
    ...
    name_entry_box.grid(column=1, row=1, columnspan=2)
    ...
    rh_data.set('-')
    rh_checkbox = ttk.Checkbutton(root, text="Rh Positive", variable=rh_data,
                                  onvalue='+', offvalue='-')
    ...
    tk_image = load_and_resize_image("images/IMG_0017.JPG")
